class User < ApplicationRecord
  ...
  scope :search, -> (search_params) do
    ...
    first_like(search_params[:first_name])
      .last_like(search_params[:last_name])
      .first_cana_like(search_params[:first_name_cana])
      .last_cana_like(search_params[:last_name_cana])
      .phone_like(search_params[:phone_number])
      .email_like(search_params[:email])
      .customer_number_like(search_params[:customer_number])
      .member_like(search_params[:menber_id])
      .visit_form(search_params[:visit_form])
      .visit_to(search_params[:visit_to])
      .visit_time_like(search_params[:visit_time])
      .birthday_form(search_params[:birthday_form])
      .birthday_to(search_params[:birthday_to])
      .age_is(search_params[:age_is])
      .gender_like(search_params[:gender_id])
      .job_like(search_params[:job_id])
      .stylist_like(search_params[:stylist_id])
  end
  ...
  scope :visit_form, -> (from) { where('? <= visit', from) if from.present? }
  ...
  scope :birthday_form, -> (from) { where('? <= birthday', from) if from.present? }
